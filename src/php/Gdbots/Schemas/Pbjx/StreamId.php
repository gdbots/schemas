...
final class StreamId implements Identifier, \JsonSerializable
{
    ...
    /**
     * Creates a stream id from a string, assuming it was generated
    ...
    /**
     * Returns a string that can be used for an AWS SNS Topic by
     * replacing colons with two underscores and periods with
     * two hyphens.
     *
     * @return string
     */
