...
final class TiktokVideoFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:tiktok-video-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:tiktok-video-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:tiktok-video-field:v1';
    const MIXINS = [
