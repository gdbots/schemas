...
final class YoutubeVideoFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:youtube-video-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:youtube-video-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:youtube-video-field:v1';
    const MIXINS = [
