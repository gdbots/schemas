...
final class YoutubeUserFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:youtube-user-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:youtube-user-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:youtube-user-field:v1';
    const MIXINS = [
