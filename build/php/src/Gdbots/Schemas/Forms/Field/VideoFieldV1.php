...
final class VideoFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:video-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:video-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:video-field:v1';
