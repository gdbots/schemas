...
final class PhotoFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:photo-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:photo-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:photo-field:v1';
