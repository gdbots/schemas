...
final class DocumentFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:document-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:document-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:document-field:v1';
    ...
    const MAX_BYTES_FIELD = 'max_bytes';
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::PII_IMPACT_FIELD, T\StringEnumType::create())
                    ...
                    ->build(),
                Fb::create(self::MAX_BYTES_FIELD, T\IntType::create())
                    ->build(),
            ],
            self::MIXINS
        );
