...
final class PhoneFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:phone-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:phone-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:phone-field:v1';
    const MIXINS = [
