...
final class FacebookUserFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:facebook-user-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:facebook-user-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:facebook-user-field:v1';
    const MIXINS = [
