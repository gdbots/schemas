...
final class CountryFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:country-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:country-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:country-field:v1';
    const MIXINS = [
