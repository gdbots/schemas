...
final class EmailFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:email-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:email-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:email-field:v1';
    const MIXINS = [
