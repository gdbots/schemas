...
final class PinterestUserFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:pinterest-user-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:pinterest-user-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:pinterest-user-field:v1';
    const MIXINS = [
