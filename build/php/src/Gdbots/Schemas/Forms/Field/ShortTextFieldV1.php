...
final class ShortTextFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:short-text-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:short-text-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:short-text-field:v1';
    ...
    const MIN_LENGTH_FIELD = 'min_length';
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::PII_IMPACT_FIELD, T\StringEnumType::create())
                    ...
                    ->build(),
                Fb::create(self::MIN_LENGTH_FIELD, T\TinyIntType::create())
                    ->build(),
                Fb::create(self::MAX_LENGTH_FIELD, T\TinyIntType::create())
                    ->build(),
            ],
            self::MIXINS
        );
