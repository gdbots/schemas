...
final class YesNoFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:yes-no-field:1-0-1';
    const SCHEMA_CURIE = 'gdbots:forms:field:yes-no-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:yes-no-field:v1';
    ...
    const YES_LABEL_FIELD = 'yes_label';
    const NO_LABEL_FIELD = 'no_label';
    const IS_CONSENT_FIELD = 'is_consent';
    ...
    const FIELDS = [
      ...
      self::YES_LABEL_FIELD,
      self::NO_LABEL_FIELD,
      self::IS_CONSENT_FIELD,
    ];
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::PII_IMPACT_FIELD, T\StringEnumType::create())
                    ...
                    ->build(),
                Fb::create(self::YES_LABEL_FIELD, T\StringType::create())
                    ->build(),
                Fb::create(self::NO_LABEL_FIELD, T\StringType::create())
                    ->build(),
                /*
                 ...
                 */
                Fb::create(self::IS_CONSENT_FIELD, T\BooleanType::create())
                    ->build(),
            ],
            self::MIXINS
        );
