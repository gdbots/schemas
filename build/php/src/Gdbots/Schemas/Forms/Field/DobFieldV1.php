...
final class DobFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:dob-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:dob-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:dob-field:v1';
