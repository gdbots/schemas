...
final class NumberFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:number-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:number-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:number-field:v1';
    ...
    const MIN_VALUE_FIELD = 'min_value';
    const MAX_VALUE_FIELD = 'max_value';
    const DECIMALS_FIELD = 'decimals';
    ...
    const FIELDS = [
      ...
      self::MIN_VALUE_FIELD,
      self::MAX_VALUE_FIELD,
      self::DECIMALS_FIELD,
    ];
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::PII_IMPACT_FIELD, T\StringEnumType::create())
                    ...
                    ->build(),
                Fb::create(self::MIN_VALUE_FIELD, T\IntType::create())
                    ->build(),
                Fb::create(self::MAX_VALUE_FIELD, T\IntType::create())
                    ->build(),
                /*
                 * Number of decimal places to allow. A "0" denotes this number field
                 * will require an integer.
                 */
                Fb::create(self::DECIMALS_FIELD, T\TinyIntType::create())
                    ->max(6)
                    ->build(),
            ],
            self::MIXINS
