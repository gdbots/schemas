...
final class TwitterUserFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:twitter-user-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:twitter-user-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:twitter-user-field:v1';
