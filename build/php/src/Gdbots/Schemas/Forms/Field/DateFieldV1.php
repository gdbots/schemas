...
final class DateFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:date-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:date-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:date-field:v1';
