...
final class HeightFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:height-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:height-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:height-field:v1';
    ...
    const MIN_HEIGHT_FIELD = 'min_height';
    const MAX_HEIGHT_FIELD = 'max_height';
    ...
    protected static function defineSchema(): Schema
    {
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                 ...
                 */
                Fb::create(self::MIN_HEIGHT_FIELD, T\TinyIntType::create())
                    ->build(),
                /*
                 * The person's maximum physical height recorded in inches.
                 */
                Fb::create(self::MAX_HEIGHT_FIELD, T\TinyIntType::create())
                    ->build(),
            ],
            self::MIXINS
        );
