...
final class AgeFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:age-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:age-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:age-field:v1';
    ...
    const MIN_AGE_FIELD = 'min_age';
    const MAX_AGE_FIELD = 'max_age';
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::PII_IMPACT_FIELD, T\StringEnumType::create())
                    ...
                    ->build(),
                Fb::create(self::MIN_AGE_FIELD, T\TinyIntType::create())
                    ->build(),
                Fb::create(self::MAX_AGE_FIELD, T\TinyIntType::create())
                    ->build(),
            ],
            self::MIXINS
        );
