...
final class InstagramUserFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:instagram-user-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:instagram-user-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:instagram-user-field:v1';
