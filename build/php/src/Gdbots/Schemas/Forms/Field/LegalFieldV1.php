...
final class LegalFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:legal-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:legal-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:legal-field:v1';
    const MIXINS = [
