...
final class SexualOrientationFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:sexual-orientation-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:sexual-orientation-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:sexual-orientation-field:v1';
    const MIXINS = [
