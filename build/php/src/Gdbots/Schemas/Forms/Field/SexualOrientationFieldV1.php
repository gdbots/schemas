...
final class SexualOrientationFieldV1 extends AbstractMessage implements
    ...
    GdbotsFormsFieldV1
{
    ...
    {
        return new Schema('pbj:gdbots:forms:field:sexual-orientation-field:1-0-0', __CLASS__,
            [],
            [
