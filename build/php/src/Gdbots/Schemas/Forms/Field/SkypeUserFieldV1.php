...
final class SkypeUserFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:skype-user-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:skype-user-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:skype-user-field:v1';
    const MIXINS = [
