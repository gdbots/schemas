...
final class WebsiteFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:website-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:website-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:website-field:v1';
    const MIXINS = [
