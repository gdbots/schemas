...
final class GenderFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:gender-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:gender-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:gender-field:v1';
