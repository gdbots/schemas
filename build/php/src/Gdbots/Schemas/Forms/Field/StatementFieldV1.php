...
final class StatementFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:statement-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:statement-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:statement-field:v1';
    const MIXINS = [
