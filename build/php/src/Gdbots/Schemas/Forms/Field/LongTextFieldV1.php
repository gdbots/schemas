...
final class LongTextFieldV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:forms:field:long-text-field:1-0-0';
    const SCHEMA_CURIE = 'gdbots:forms:field:long-text-field';
    const SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:long-text-field:v1';
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::PII_IMPACT_FIELD, T\StringEnumType::create())
                    ...
                    ->build(),
                Fb::create(self::MIN_LENGTH_FIELD, T\SmallIntType::create())
                    ->build(),
                Fb::create(self::MAX_LENGTH_FIELD, T\SmallIntType::create())
                    ->build(),
            ],
            self::MIXINS
        );
