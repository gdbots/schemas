<?php
// @link http://schemas.gdbots.io/json-schema/gdbots/forms/mixin/import-form/1-0-0.json#
namespace Gdbots\Schemas\Forms\Mixin\ImportForm;
...
final class ImportFormV1Mixin extends AbstractMixin
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return SchemaId::fromString('pbj:gdbots:forms:mixin:import-form:1-0-0');
    }
