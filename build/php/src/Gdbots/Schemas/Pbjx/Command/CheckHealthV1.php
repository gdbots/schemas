...
final class CheckHealthV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:pbjx:command:check-health:1-0-0';
    const SCHEMA_CURIE = 'gdbots:pbjx:command:check-health';
    const SCHEMA_CURIE_MAJOR = 'gdbots:pbjx:command:check-health:v1';
