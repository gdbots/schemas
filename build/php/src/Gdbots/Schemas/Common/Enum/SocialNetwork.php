...
final class SocialNetwork extends Enum
{
    ...
    const BAIDUTIEBA = 'baidutieba';
    const TWITTER = 'twitter';
    const VIBER = 'viber';
    const TUMBLR = 'tumblr';
    const SNAPCHAT = 'snapchat';
    const LINE = 'line';
    const SINAWEIBO = 'sinaweibo';
    const VK = 'vk';
    const REDDIT = 'reddit';
    const YY = 'yy';
    const TARINGA = 'taringa';
    ...
    const MEETME = 'meetme';
    const MEETUP = 'meetup';
    const SKYROCK = 'skyrock';
    const DELICIOUS = 'delicious';
    const KIWIBOX = 'kiwibox';
    const SNAPFISH = 'snapfish';
    const FLICKR = 'flickr';
    const PHOTOBUCKET = 'photobucket';
    const DEVIANTART = 'deviantart';
    const FOTOLOG = 'fotolog';
    const PINTEREST = 'pinterest';
    const BUZZNET = 'buzznet';
    const WEHEARTIT = 'weheartit';
    const PATH = 'path';
    const LASTFM = 'lastfm';
    const REVERBNATION = 'reverbnation';
    const CROSSTV = 'crosstv';
    const FLIXSTER = 'flixster';
    const GAIAONLINE = 'gaiaonline';
    const BLACKPLANET = 'blackplanet';
    const CARE2 = 'care2';
    const CARINGBRIDGE = 'caringbridge';
    const VAMPIREFREAKS = 'vampirefreaks';
    const CAFEMOM = 'cafemom';
    const RAVELRY = 'ravelry';
    const ASMALLWORLD = 'asmallworld';
    const NEXTDOOR = 'nextdoor';
    const WAYN = 'wayn';
    const COUCHSURFING = 'couchsurfing';
    const TRAVBUDDY = 'travbuddy';
    const CELLUFUN = 'cellufun';
    const MOCOSPACE = 'mocospace';
    const ITSMY = 'itsmy';
    ...
    const MYLIFE = 'mylife';
    const MYHERITAGE = 'myheritage';
    const VIADEO = 'viadeo';
    const RYZE = 'ryze';
    const XING = 'xing';
    const WEEWORLD = 'weeworld';
    const HABBO = 'habbo';
    const TUENTI = 'tuenti';
    const XANGA = 'xanga';
    const SOLABORATE = 'solaborate';
    const PLURK = 'plurk';
