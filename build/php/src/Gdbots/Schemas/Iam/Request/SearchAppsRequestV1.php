...
final class SearchAppsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:request:search-apps-request:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:request:search-apps-request';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:request:search-apps-request:v1';
    const MIXINS = [
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create('sort', T\StringEnumType::create())
                    ...
                    ->className(SearchAppsSort::class)
                    ->build(),
            ],
            self::MIXINS
        );
