...
{
    const SCHEMA_ID = 'pbj:gdbots:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:request:search-users-response:v1';
    const MIXINS = [
