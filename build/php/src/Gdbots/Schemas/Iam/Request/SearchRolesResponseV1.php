...
final class SearchRolesResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:request:search-roles-response:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:request:search-roles-response';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:request:search-roles-response:v1';
