...
final class SearchAppsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:request:search-apps-response:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:request:search-apps-response';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:request:search-apps-response:v1';
    const MIXINS = [
