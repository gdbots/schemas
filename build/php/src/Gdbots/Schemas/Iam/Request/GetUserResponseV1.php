...
final class GetUserResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:request:get-user-response:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:request:get-user-response';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:request:get-user-response:v1';
    const MIXINS = [
