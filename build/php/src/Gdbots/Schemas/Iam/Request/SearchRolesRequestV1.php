...
final class SearchRolesRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:request:search-roles-request:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:request:search-roles-request';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:request:search-roles-request:v1';
    const MIXINS = [
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create('sort', T\StringEnumType::create())
                    ...
                    ->className(SearchRolesSort::class)
                    ->build(),
            ],
            self::MIXINS
        );
