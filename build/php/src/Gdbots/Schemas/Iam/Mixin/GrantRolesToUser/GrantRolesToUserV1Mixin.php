...
final class GrantRolesToUserV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:iam:mixin:grant-roles-to-user:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:mixin:grant-roles-to-user';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:mixin:grant-roles-to-user:v1';
