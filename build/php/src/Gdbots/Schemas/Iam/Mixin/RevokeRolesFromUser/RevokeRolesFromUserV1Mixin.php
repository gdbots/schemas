...
final class RevokeRolesFromUserV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:iam:mixin:revoke-roles-from-user:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:mixin:revoke-roles-from-user';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:mixin:revoke-roles-from-user:v1';
