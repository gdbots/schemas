...
final class UserRolesGrantedV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:iam:mixin:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:mixin:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:mixin:user-roles-granted:v1';
