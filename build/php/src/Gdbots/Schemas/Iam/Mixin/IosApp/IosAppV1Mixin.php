...
final class IosAppV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:iam:mixin:ios-app:1-0-3';
    const SCHEMA_CURIE = 'gdbots:iam:mixin:ios-app';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:mixin:ios-app:v1';
