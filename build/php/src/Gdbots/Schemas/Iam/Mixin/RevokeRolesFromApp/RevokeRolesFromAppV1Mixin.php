...
final class RevokeRolesFromAppV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:iam:mixin:revoke-roles-from-app:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:mixin:revoke-roles-from-app';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:mixin:revoke-roles-from-app:v1';
