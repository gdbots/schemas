...
final class AppRolesRevokedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:event:app-roles-revoked:v1';
    const MIXINS = [
