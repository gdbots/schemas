...
final class AppRolesGrantedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:event:app-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:event:app-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:event:app-roles-granted:v1';
    const MIXINS = [
