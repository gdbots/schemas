...
final class UserRolesGrantedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:event:user-roles-granted:v1';
    const MIXINS = [
