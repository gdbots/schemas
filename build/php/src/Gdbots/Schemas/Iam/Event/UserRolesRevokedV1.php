...
final class UserRolesRevokedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:event:user-roles-revoked:v1';
