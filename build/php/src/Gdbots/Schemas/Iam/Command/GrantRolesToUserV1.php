...
final class GrantRolesToUserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:command:grant-roles-to-user:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:command:grant-roles-to-user';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:command:grant-roles-to-user:v1';
