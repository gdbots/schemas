...
namespace Gdbots\Schemas\Iam\Command;
...
final class RevokeRolesFromUserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:command:revoke-roles-from-user:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:command:revoke-roles-from-user';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:command:revoke-roles-from-user:v1';
