...
final class RevokeRolesFromAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:command:revoke-roles-from-app:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:command:revoke-roles-from-app';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:command:revoke-roles-from-app:v1';
    const MIXINS = [
