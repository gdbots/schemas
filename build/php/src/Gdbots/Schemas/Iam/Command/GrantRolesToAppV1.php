...
final class GrantRolesToAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:iam:command:grant-roles-to-app:1-0-0';
    const SCHEMA_CURIE = 'gdbots:iam:command:grant-roles-to-app';
    const SCHEMA_CURIE_MAJOR = 'gdbots:iam:command:grant-roles-to-app:v1';
