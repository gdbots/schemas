...
final class NodeUnpublishedV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:mixin:node-unpublished:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:mixin:node-unpublished';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:mixin:node-unpublished:v1';
