...
final class NodeDeletedV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:mixin:node-deleted:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:mixin:node-deleted';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:mixin:node-deleted:v1';
