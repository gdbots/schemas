...
final class NodeScheduledV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:mixin:node-scheduled:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:mixin:node-scheduled';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:mixin:node-scheduled:v1';
