...
final class NodeCreatedV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:mixin:node-created:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:mixin:node-created';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:mixin:node-created:v1';
