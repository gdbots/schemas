...
final class RenameNodeV1Mixin
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:mixin:rename-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:mixin:rename-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:mixin:rename-node:v1';
