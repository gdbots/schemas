...
final class LockNodeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:lock-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:lock-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:lock-node:v1';
