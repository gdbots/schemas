...
final class UpdateNodeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:update-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:update-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-node:v1';
    const MIXINS = [
