...
final class PublishNodeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:publish-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:publish-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:publish-node:v1';
