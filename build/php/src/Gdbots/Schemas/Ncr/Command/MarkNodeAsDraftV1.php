...
final class MarkNodeAsDraftV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:mark-node-as-draft:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:mark-node-as-draft';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:mark-node-as-draft:v1';
    const MIXINS = [
