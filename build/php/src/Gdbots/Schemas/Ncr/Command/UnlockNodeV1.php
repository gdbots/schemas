...
final class UnlockNodeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:unlock-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:unlock-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:unlock-node:v1';
