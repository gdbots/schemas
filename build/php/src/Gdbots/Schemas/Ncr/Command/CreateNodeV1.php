...
final class CreateNodeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:create-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:create-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:create-node:v1';
    const MIXINS = [
