...
final class MarkNodeAsPendingV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:mark-node-as-pending:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:mark-node-as-pending';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:mark-node-as-pending:v1';
    const MIXINS = [
