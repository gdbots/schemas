...
final class UpdateLabelsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:update-labels:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:update-labels';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-labels:v1';
