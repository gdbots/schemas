...
final class UpdateTagsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:update-tags:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:update-tags';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-tags:v1';
