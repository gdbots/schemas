...
final class RenameNodeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:rename-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:rename-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:rename-node:v1';
    const MIXINS = [
