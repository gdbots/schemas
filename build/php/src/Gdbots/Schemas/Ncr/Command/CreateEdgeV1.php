...
final class CreateEdgeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:create-edge:1-0-1';
    const SCHEMA_CURIE = 'gdbots:ncr:command:create-edge';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:create-edge:v1';
