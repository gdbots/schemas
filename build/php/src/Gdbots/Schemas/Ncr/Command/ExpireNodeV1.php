...
final class ExpireNodeV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:expire-node:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:expire-node';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:expire-node:v1';
