...
final class UpdateNodeLabelsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:update-node-labels:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:update-node-labels';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-node-labels:v1';
