...
final class UpdateNodeTagsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:command:update-node-tags:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:command:update-node-tags';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-node-tags:v1';
    ...
    const ADD_TAGS_FIELD = 'add_tags';
    const REMOVE_TAGS_FIELD = 'remove_tags';
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::NODE_REF_FIELD, T\NodeRefType::create())
                    ->required()
                    ->build(),
                Fb::create(self::ADD_TAGS_FIELD, T\StringType::create())
                    ->asAMap()
                    ->pattern('^[\w\/\.:-]+$')
                    ->build(),
                Fb::create(self::REMOVE_TAGS_FIELD, T\StringType::create())
                    ->asASet()
                    ->pattern('^[\w-]+$')
                    ->build(),
            ],
