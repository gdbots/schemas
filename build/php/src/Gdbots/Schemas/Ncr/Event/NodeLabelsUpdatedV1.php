...
final class NodeLabelsUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-labels-updated:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-labels-updated';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-labels-updated:v1';
