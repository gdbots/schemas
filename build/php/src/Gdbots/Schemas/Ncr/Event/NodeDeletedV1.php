...
final class NodeDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-deleted:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-deleted';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-deleted:v1';
    const MIXINS = [
