...
final class NodeExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-expired:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-expired';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-expired:v1';
