...
final class TagsUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:tags-updated:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:tags-updated';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:tags-updated:v1';
    ...
    const TAGS_ADDED_FIELD = 'tags_added';
    const TAGS_REMOVED_FIELD = 'tags_removed';
    ...
    const FIELDS = [
      ...
      self::NODE_REF_FIELD,
      self::TAGS_ADDED_FIELD,
      self::TAGS_REMOVED_FIELD,
    ];
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create(self::NODE_REF_FIELD, T\NodeRefType::create())
                    ->required()
                    ->build(),
                Fb::create(self::TAGS_ADDED_FIELD, T\StringType::create())
                    ->asAMap()
                    ->pattern('^[\w\/\.:-]+$')
                    ->build(),
                Fb::create(self::TAGS_REMOVED_FIELD, T\StringType::create())
                    ->asASet()
                    ->pattern('^[\w-]+$')
                    ->build(),
            ],
