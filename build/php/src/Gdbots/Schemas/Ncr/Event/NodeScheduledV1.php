...
final class NodeScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-scheduled:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-scheduled';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-scheduled:v1';
    const MIXINS = [
