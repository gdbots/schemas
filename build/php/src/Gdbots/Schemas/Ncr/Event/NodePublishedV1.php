...
final class NodePublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-published:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-published';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-published:v1';
    const MIXINS = [
