...
final class NodeRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-renamed:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-renamed';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-renamed:v1';
    const MIXINS = [
