...
final class NodeLockedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-locked:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-locked';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-locked:v1';
    const MIXINS = [
