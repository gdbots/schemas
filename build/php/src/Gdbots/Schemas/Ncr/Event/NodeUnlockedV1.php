...
final class NodeUnlockedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-unlocked:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-unlocked';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-unlocked:v1';
    const MIXINS = [
