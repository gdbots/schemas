...
final class NodeTagsUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-tags-updated:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-tags-updated';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-tags-updated:v1';
