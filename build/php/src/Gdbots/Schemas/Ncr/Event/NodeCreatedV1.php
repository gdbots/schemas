...
final class NodeCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-created:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-created';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-created:v1';
    const MIXINS = [
