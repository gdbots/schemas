...
final class NodeMarkedAsPendingV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-marked-as-pending:v1';
