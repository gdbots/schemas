...
final class NodeUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:node-unpublished:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:event:node-unpublished';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-unpublished:v1';
    const MIXINS = [
