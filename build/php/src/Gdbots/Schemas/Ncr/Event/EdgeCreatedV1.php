...
final class EdgeCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:event:edge-created:1-0-1';
    const SCHEMA_CURIE = 'gdbots:ncr:event:edge-created';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:edge-created:v1';
    const MIXINS = [
