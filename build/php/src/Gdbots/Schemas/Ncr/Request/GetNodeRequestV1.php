...
final class GetNodeRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:request:get-node-request:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:request:get-node-request';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:request:get-node-request:v1';
    const MIXINS = [
