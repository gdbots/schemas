...
final class GetNodeResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:gdbots:ncr:request:get-node-response:1-0-0';
    const SCHEMA_CURIE = 'gdbots:ncr:request:get-node-response';
    const SCHEMA_CURIE_MAJOR = 'gdbots:ncr:request:get-node-response:v1';
    const MIXINS = [
