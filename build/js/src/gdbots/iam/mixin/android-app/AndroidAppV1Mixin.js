...
export default class AndroidAppV1Mixin {
  /**
   * @returns {SchemaId}
   */
  static getId() {
...
const M = AndroidAppV1Mixin;
M.SCHEMA_ID = 'pbj:gdbots:iam:mixin:android-app:1-0-3';
M.SCHEMA_CURIE = 'gdbots:iam:mixin:android-app';
M.SCHEMA_CURIE_MAJOR = 'gdbots:iam:mixin:android-app:v1';
