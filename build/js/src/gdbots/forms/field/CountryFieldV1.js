    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.PII_IMPACT_FIELD, T.StringEnumType.create())
          ...
          .build(),
        Fb.create(this.DEFAULT_COUNTRY_FIELD, T.StringType.create())
          .pattern('^[A-Z]{2}$')
          .build(),
        Fb.create(this.PREFERRED_COUNTRIES_FIELD, T.StringType.create())
          .asASet()
          .pattern('^[A-Z]{2}$')
          .build(),
        Fb.create(this.INCLUDED_COUNTRIES_FIELD, T.StringType.create())
          .asASet()
          .pattern('^[A-Z]{2}$')
          .build(),
        Fb.create(this.EXCLUDED_COUNTRIES_FIELD, T.StringType.create())
          .asASet()
          .pattern('^[A-Z]{2}$')
          .build(),
      ],
...
const M = CountryFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:country-field:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:country-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:country-field:v1';
...
M.prototype.DEFAULT_COUNTRY_FIELD = M.DEFAULT_COUNTRY_FIELD = 'default_country';
M.prototype.PREFERRED_COUNTRIES_FIELD = M.PREFERRED_COUNTRIES_FIELD = 'preferred_countries';
M.prototype.INCLUDED_COUNTRIES_FIELD = M.INCLUDED_COUNTRIES_FIELD = 'included_countries';
M.prototype.EXCLUDED_COUNTRIES_FIELD = M.EXCLUDED_COUNTRIES_FIELD = 'excluded_countries';
...
M.prototype.FIELDS = M.FIELDS = [
  ...
  M.LINK_URL_FIELD,
  M.PII_IMPACT_FIELD,
  M.DEFAULT_COUNTRY_FIELD,
  M.PREFERRED_COUNTRIES_FIELD,
  M.INCLUDED_COUNTRIES_FIELD,
  M.EXCLUDED_COUNTRIES_FIELD,
];
