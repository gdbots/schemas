    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.PII_IMPACT_FIELD, T.StringEnumType.create())
          ...
          .build(),
        Fb.create(this.MAX_BYTES_FIELD, T.IntType.create())
          .build(),
      ],
      this.MIXINS,
    );
...
const M = VideoFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:video-field:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:video-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:video-field:v1';
...
M.prototype.MAX_BYTES_FIELD = M.MAX_BYTES_FIELD = 'max_bytes';
