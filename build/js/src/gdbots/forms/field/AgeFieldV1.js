    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.PII_IMPACT_FIELD, T.StringEnumType.create())
          ...
          .build(),
        Fb.create(this.MIN_AGE_FIELD, T.TinyIntType.create())
          .build(),
        Fb.create(this.MAX_AGE_FIELD, T.TinyIntType.create())
          .build(),
      ],
      this.MIXINS,
    );
...
const M = AgeFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:age-field:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:age-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:age-field:v1';
...
M.prototype.MIN_AGE_FIELD = M.MIN_AGE_FIELD = 'min_age';
M.prototype.MAX_AGE_FIELD = M.MAX_AGE_FIELD = 'max_age';
