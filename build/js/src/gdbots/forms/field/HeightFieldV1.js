  ...
  static defineSchema() {
    return new Schema(this.SCHEMA_ID, this,
      [
         ...
         */
        Fb.create(this.MIN_HEIGHT_FIELD, T.TinyIntType.create())
          .build(),
        /*
         * The person's maximum physical height recorded in inches.
         */
        Fb.create(this.MAX_HEIGHT_FIELD, T.TinyIntType.create())
          .build(),
      ],
      this.MIXINS,
    );
...
const M = HeightFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:height-field:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:height-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:height-field:v1';
...
M.prototype.MIN_HEIGHT_FIELD = M.MIN_HEIGHT_FIELD = 'min_height';
M.prototype.MAX_HEIGHT_FIELD = M.MAX_HEIGHT_FIELD = 'max_height';
