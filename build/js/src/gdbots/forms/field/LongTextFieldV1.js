    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.PII_IMPACT_FIELD, T.StringEnumType.create())
          ...
          .build(),
        Fb.create(this.MIN_LENGTH_FIELD, T.SmallIntType.create())
          .build(),
        Fb.create(this.MAX_LENGTH_FIELD, T.SmallIntType.create())
          .build(),
      ],
      this.MIXINS,
    );
...
const M = LongTextFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:long-text-field:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:long-text-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:long-text-field:v1';
