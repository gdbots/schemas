    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.PII_IMPACT_FIELD, T.StringEnumType.create())
          ...
          .build(),
        Fb.create(this.MIN_LENGTH_FIELD, T.TinyIntType.create())
          .build(),
        Fb.create(this.MAX_LENGTH_FIELD, T.TinyIntType.create())
          .build(),
      ],
      this.MIXINS,
    );
...
const M = ShortTextFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:short-text-field:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:short-text-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:short-text-field:v1';
...
M.prototype.MIN_LENGTH_FIELD = M.MIN_LENGTH_FIELD = 'min_length';
M.prototype.MAX_LENGTH_FIELD = M.MAX_LENGTH_FIELD = 'max_length';
