// @link http://schemas.gdbots.io/json-schema/gdbots/forms/field/tiktok-video-field/1-0-0.json#
...
export default class TiktokVideoFieldV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = TiktokVideoFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:tiktok-video-field:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:tiktok-video-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:tiktok-video-field:v1';
