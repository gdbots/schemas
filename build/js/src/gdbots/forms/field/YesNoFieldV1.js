    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.PII_IMPACT_FIELD, T.StringEnumType.create())
          ...
          .build(),
        Fb.create(this.YES_LABEL_FIELD, T.StringType.create())
          .build(),
        Fb.create(this.NO_LABEL_FIELD, T.StringType.create())
          .build(),
        /*
         ...
         */
        Fb.create(this.IS_CONSENT_FIELD, T.BooleanType.create())
          .build(),
      ],
      this.MIXINS,
    );
...
const M = YesNoFieldV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:forms:field:yes-no-field:1-0-1';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:forms:field:yes-no-field';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:forms:field:yes-no-field:v1';
...
M.prototype.YES_LABEL_FIELD = M.YES_LABEL_FIELD = 'yes_label';
M.prototype.NO_LABEL_FIELD = M.NO_LABEL_FIELD = 'no_label';
M.prototype.IS_CONSENT_FIELD = M.IS_CONSENT_FIELD = 'is_consent';
