// @link http://schemas.gdbots.io/json-schema/gdbots/ncr/command/update-tags/1-0-0.json#
...
export default class UpdateTagsV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.NODE_REF_FIELD, T.NodeRefType.create())
          .required()
          .build(),
        Fb.create(this.ADD_TAGS_FIELD, T.StringType.create())
          .asAMap()
          .pattern('^[\\w\\/\\.:-]+$')
          .build(),
        Fb.create(this.REMOVE_TAGS_FIELD, T.StringType.create())
          .asASet()
          .pattern('^[\\w-]+$')
          .build(),
      ],
...
const M = UpdateTagsV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:ncr:command:update-tags:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:ncr:command:update-tags';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-tags:v1';
...
M.prototype.ADD_TAGS_FIELD = M.ADD_TAGS_FIELD = 'add_tags';
M.prototype.REMOVE_TAGS_FIELD = M.REMOVE_TAGS_FIELD = 'remove_tags';
