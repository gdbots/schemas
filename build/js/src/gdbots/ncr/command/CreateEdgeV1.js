// @link http://schemas.gdbots.io/json-schema/gdbots/ncr/command/create-edge/1-0-1.json#
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.TAGS_FIELD, T.StringType.create())
          ...
          .pattern('^[\\w\\/\\.:-]+$')
          .build(),
        Fb.create(this.EDGE_FIELD, T.MessageType.create())
          .required()
          .anyOfCuries([
...
const M = CreateEdgeV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:ncr:command:create-edge:1-0-1';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:ncr:command:create-edge';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:create-edge:v1';
...
M.prototype.EDGE_FIELD = M.EDGE_FIELD = 'edge';
