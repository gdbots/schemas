// @link http://schemas.gdbots.io/json-schema/gdbots/ncr/command/update-node/1-0-0.json#
...
export default class UpdateNodeV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = UpdateNodeV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:ncr:command:update-node:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:ncr:command:update-node';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-node:v1';
...
M.prototype.NEW_NODE_FIELD = M.NEW_NODE_FIELD = 'new_node';
M.prototype.OLD_NODE_FIELD = M.OLD_NODE_FIELD = 'old_node';
