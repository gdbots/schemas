// @link http://schemas.gdbots.io/json-schema/gdbots/ncr/command/update-labels/1-0-0.json#
...
export default class UpdateLabelsV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = UpdateLabelsV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:ncr:command:update-labels:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:ncr:command:update-labels';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:update-labels:v1';
