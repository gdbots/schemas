...
const M = RenameNodeV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:ncr:command:rename-node:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:ncr:command:rename-node';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:command:rename-node:v1';
...
M.prototype.NODE_STATUS_FIELD = M.NODE_STATUS_FIELD = 'node_status';
M.prototype.NEW_SLUG_FIELD = M.NEW_SLUG_FIELD = 'new_slug';
M.prototype.OLD_SLUG_FIELD = M.OLD_SLUG_FIELD = 'old_slug';
