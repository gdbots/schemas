...
export default class RenameNodeV1Mixin {
  /**
   * @returns {SchemaId}
   */
  static getId() {
...
const M = RenameNodeV1Mixin;
M.SCHEMA_ID = 'pbj:gdbots:ncr:mixin:rename-node:1-0-0';
M.SCHEMA_CURIE = 'gdbots:ncr:mixin:rename-node';
M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:mixin:rename-node:v1';
