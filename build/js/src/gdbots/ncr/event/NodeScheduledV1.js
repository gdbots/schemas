...
export default class NodeScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:gdbots:ncr:event:node-scheduled:1-0-0', NodeScheduledV1,
      [
...
GdbotsPbjxEventV1Trait(NodeScheduledV1);
MessageResolver.register('gdbots:ncr:event:node-scheduled', NodeScheduledV1);
Object.freeze(NodeScheduledV1);
Object.freeze(NodeScheduledV1.prototype);
