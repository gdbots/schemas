...
const M = NodeScheduledV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:ncr:event:node-scheduled:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:ncr:event:node-scheduled';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:node-scheduled:v1';
...
M.prototype.PUBLISH_AT_FIELD = M.PUBLISH_AT_FIELD = 'publish_at';
