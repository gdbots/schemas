...
export default class NodePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:gdbots:ncr:event:node-published:1-0-0', NodePublishedV1,
      [
...
GdbotsPbjxEventV1Trait(NodePublishedV1);
MessageResolver.register('gdbots:ncr:event:node-published', NodePublishedV1);
Object.freeze(NodePublishedV1);
Object.freeze(NodePublishedV1.prototype);
