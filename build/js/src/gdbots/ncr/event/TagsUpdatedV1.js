// @link http://schemas.gdbots.io/json-schema/gdbots/ncr/event/tags-updated/1-0-0.json#
...
export default class TagsUpdatedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create(this.NODE_REF_FIELD, T.NodeRefType.create())
          .required()
          .build(),
        Fb.create(this.TAGS_ADDED_FIELD, T.StringType.create())
          .asAMap()
          .pattern('^[\\w\\/\\.:-]+$')
          .build(),
        Fb.create(this.TAGS_REMOVED_FIELD, T.StringType.create())
          .asASet()
          .pattern('^[\\w-]+$')
          .build(),
      ],
...
const M = TagsUpdatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:gdbots:ncr:event:tags-updated:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'gdbots:ncr:event:tags-updated';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'gdbots:ncr:event:tags-updated:v1';
...
M.prototype.TAGS_ADDED_FIELD = M.TAGS_ADDED_FIELD = 'tags_added';
M.prototype.TAGS_REMOVED_FIELD = M.TAGS_REMOVED_FIELD = 'tags_removed';
